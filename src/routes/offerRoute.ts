...
offerRoute.put('/addToDeclinedOffers/:id', middlewares.checkAuthentication, middlewares.checkIsApplicant, offerController.addToDeclinedOffer)
offerRoute.put('/addToAcceptedOffers/:id', middlewares.checkAuthentication, middlewares.checkIsApplicant, offerController.addToAcceptedOffer)
